...
<body>
    ...
    <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <div class="card mb-4"> 
                    <br>
                    <h1 class="px-3">Struktur Organisasi</h1>
                    <br>

                    <div class="card-header">
                        <i class="fas fa-table me-1"></i>
                        <a href="tambahOrganisasi.php">Tambah Struktur Organisasi</a>
                    </div>
                    <div class="card-body"> 
                        <table id="datatablesSimple">
                            ...
                            <tr>
                                <td><?= $i; ?></td>
                                <td>
                                    <a href="ubahOrganisasi.php?id=<?= $row["id"]; ?>">ubah</a> |
                                    <a href="hapusOrganisasi.php?id=<?= $row["id"]; ?>" onclick="return confirm('yakin?');">hapus</a>
                                </td>
