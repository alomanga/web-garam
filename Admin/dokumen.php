...
<body>
    ...
    <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <div class="card mb-4"> 
                    <br>
                    <h1 class="px-3">Daftar Dokumen</h1>
                    <br>

                    <div class="card-header">
                        <i class="fas fa-table me-1"></i>
                        <a href="tambahDokumen.php">Tambah Dokumen</a>
                    </div>
                    <div class="card-body"> 
                        <table id="datatablesSimple">
                            ...
                            <tr>
                                <td><?= $i; ?></td>
                                <td>
                                    <a href="ubahDokumen.php?id=<?= $row["id"]; ?>">ubah</a> |
                                    <a href="hapusDokumen.php?id=<?= $row["id"]; ?>" onclick="return confirm('yakin?');">hapus</a>
                                </td>
                                <td><?= $row["nama"]; ?></td>
                            </tr>
                            <?php $i++ ?>
